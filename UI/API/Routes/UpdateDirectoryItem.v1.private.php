 ...
 * @apiName            updateDirectoryItem
 *
 * @api                {PATCH} /v1/directory-items/:id Update directory item
 * @apiDescription     Update directory item
 *
 * @apiVersion         1.0.0
 * @apiPermission      none
 *
...
Route::patch('directory-items/{id}', [Controller::class, 'updateDirectoryItem'])
    ->name('api_directory_item_update_directory_item')
    ->middleware(['auth:api']);
